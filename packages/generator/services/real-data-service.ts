import { GridRowModel, GridColumnVisibilityModel, GridInitialState } from '../../components/DataTablePremium';
...
export function getRealGridData(rowLength: number, columns: GridColDefGenerator[]): Promise<GridDemoData> {
