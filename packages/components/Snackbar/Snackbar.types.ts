...
import { ClickAwayListener, type ClickAwayListenerProps } from '../ClickAwayListener';
import type { UseSnackbarParameters } from '../useSnackbar';
...
export type SnackbarProps<RootComponentType extends React.ElementType = SnackbarTypeMap['defaultComponent']> =
    PolymorphicProps<SnackbarTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
