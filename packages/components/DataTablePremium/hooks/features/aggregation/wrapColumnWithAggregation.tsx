...
import { GridColDef, GridFilterOperator, GridRowId } from '../../../../DataTablePro';
import { GridBaseColDef, tagInternalFilter } from '../../../../DataTablePro/internals';
...
type ColumnPropertyWrapper<P extends WrappableColumnProperty> = (params: {
    ...
    getCellAggregationResult: (id: GridRowId, field: string) => GridAggregationLookup[GridRowId][string] | null;
}) => GridBaseColDef[P];
...
const getWrappedFilterOperators: ColumnPropertyWrapper<'filterOperators'> = ({
    ...
    filterOperators!.map((operator) => {
        ...
        const getApplyFilterFn: GridFilterOperator<any, any, any>['getApplyFilterFn'] = tagInternalFilter(
            (filterItem, colDef) => {
 ...
 */
const getWrappedRenderHeader: ColumnPropertyWrapper<'renderHeader'> = ({ value: renderHeader, aggregationRule }) => {
...
export const wrapColumnWithAggregationValue = ({
    ...
    const wrapColumnProperty = <P extends WrappableColumnProperty>(property: P, wrapper: ColumnPropertyWrapper<P>) => {
 ...
 */
export const unwrapColumnFromAggregation = ({ column }: { column: GridColDef | GridColDefWithAggregationWrappers }) => {
