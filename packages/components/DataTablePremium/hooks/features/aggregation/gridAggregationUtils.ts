...
import { GRID_ID_AUTOGENERATED } from '../../../../DataTable/internals';
import { GridColDef, GridFooterNode, GridRowId, GRID_ROOT_GROUP_ID, GridGroupNode } from '../../../../DataTablePro';
import {
    addPinnedRow,
    GridColumnRawLookup,
...
export const getAggregationFunctionLabel = ({
    ...
    try {
        return apiRef.current.getLocaleText(
            `aggregationFunctionLabel${aggregationRule.aggregationFunctionName}` as 'aggregationFunctionLabelSum'
        );
    } catch (e) {
