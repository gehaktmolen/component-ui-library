...
import { GridColumnRawLookup, isSingleSelectColDef } from '../../../../DataTablePro/internals';
...
export const createGroupingColDefForAllGroupingCriteria = ({
    ...
    const commonProperties: Partial<GridColDef> = {
        ...
        width: Math.max(
            ...rowGroupingModel.map((field) => (columnsLookup[field].width ?? GRID_STRING_COL_DEF.width!) + 40),
            leafColDef?.width ?? 0
        ),
        renderCell: (params) => {
            // Render footer
