import { GridCellParams, GridKeyValue, GridValidRowModel } from '../../DataTablePro';
import type {
  GridControlledStateEventLookupPro,
  GridApiCachesPro,
  GridEventLookupPro,
} from '../../DataTablePro/typeOverloads';
...
declare module '../../DataTablePro/internals' {
  interface GridApiCaches extends GridApiCachesPremium {}
