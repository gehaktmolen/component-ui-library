...
function GridEditBooleanCell(props: GridEditBooleanCellProps) {
    ...
    return (
        <label htmlFor={id} className={twMerge(classes.root, className)} {...other}>
...
export const renderEditBooleanCell = (params: GridEditBooleanCellProps) => <GridEditBooleanCell {...params} />;
