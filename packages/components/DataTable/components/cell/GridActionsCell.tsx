...
const hasActions = (colDef: any): colDef is GridActionsColDef => typeof colDef.getActions === 'function';
...
function GridActionsCell(props: GridActionsCellProps) {
    ...
    if (!hasActions(colDef)) {
        throw new Error('Azrn: Missing the `getActions` property in the `GridColDef`.');
    }
    ...
    const handleTouchRippleRef = (index: string | number) => (instance: TouchRippleActions | null) => {
    ...
    return (
        <div role="menu" ref={rootRef} tabIndex={-1} className="actionsCell" onKeyDown={handleRootKeyDown} {...other}>
