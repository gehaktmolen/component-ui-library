...
export interface GridEditDateCellProps extends GridRenderEditCellParams, Omit<InputProps, 'id' | 'value' | 'tabIndex'> {
    /**
...
export const renderEditDateCell = (params: GridRenderEditCellParams) => <GridEditDateCell {...params} />;
