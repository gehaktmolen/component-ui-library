...
import { useId, composeClasses, useClassNamesOverride, generateUtilityClass } from '../../../../utils';
...
const useUtilityClasses = (ownerState: OwnerState) => {
    const { headerAlign, isDragging, showColumnBorder, groupId } = ownerState;
...
function GridColumnGroupHeader(props: GridColumnGroupHeaderProps) {
    const { groupId, width, depth, maxDepth, fields, height, colIndex, hasFocus, tabIndex, isLastColumn } = props;
    ...
    const headerClassName =
        typeof group.headerClassName === 'function' ? group.headerClassName(renderParams) : group.headerClassName;
