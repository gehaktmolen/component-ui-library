...
const GridColumnMenu = React.forwardRef<HTMLUListElement, GridColumnMenuProps>(function GridColumnMenu(props, ref) {
    return (
...
GridColumnMenu.propTypes = {
     ...
     * If you register a component you must pass it's `displayOrder` in `slotProps`
