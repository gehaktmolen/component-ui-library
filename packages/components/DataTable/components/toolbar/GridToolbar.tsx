...
import { GridToolbarContainer, GridToolbarContainerProps } from '../containers/GridToolbarContainer';
...
const GridToolbar = React.forwardRef<HTMLDivElement, GridToolbarProps>(function GridToolbar(props, ref) {
