...
const DataGridRaw = React.forwardRef(function DataGrid<R extends GridValidRowModel>(
    ...
    return (
        <GridContextProvider privateApiRef={privateApiRef} props={props}>
            <GridRoot className={props.className} style={props.style} ref={ref} {...props.forwardedProps}>
                <GridHeader />
...
DataGridRaw.propTypes = {
    ...
    columns: chainPropTypes(PropTypes.array.isRequired, (props) => {
        ...
        if (props.columns && props.columns.some((column) => column.resizable)) {
            return new Error(
                [
                    `Azrn: \`column.resizable = true\` is not a valid prop.`,
     ...
     * @param {GridCellParams} params With all properties from [[GridCellParams]].
     * @param {AzrnEvent<React.MouseEvent>} event The event object.
     ...
     * @param {GridCellParams} params With all properties from [[GridCellParams]].
     * @param {AzrnEvent<React.KeyboardEvent | React.MouseEvent>} event The event that caused this prop to be called.
     */
    onCellEditStart: PropTypes.func,
    /**
     * Callback fired when the cell turns to view mode.
     * @param {GridCellParams} params With all properties from [[GridCellParams]].
     * @param {AzrnEvent<AzrnBaseEvent>} event The event that caused this prop to be called.
     */
    onCellEditStop: PropTypes.func,
    /**
     * Callback fired when a keydown event comes from a cell element.
     * @param {GridCellParams} params With all properties from [[GridCellParams]].
     * @param {AzrnEvent<React.KeyboardEvent>} event The event object.
     * @param {GridCallbackDetails} details Additional details for this callback.
     */
     ...
     * @param {AzrnEvent<{}>} event The event object.
     * @param {GridCallbackDetails} details Additional details for this callback.
     */
    ...
    pagination: (props: any) => {
        if (props.pagination === false) {
            return new Error(
                [
                    'Azrn: `<DataGrid pagination={false} />` is not a valid prop.',
