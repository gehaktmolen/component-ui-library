...
import type { AzrnBaseEvent } from '../muiEvent';
...
export interface GridEventLookup
     ...
     */
    rowEditCommit: { params: GridRowId; event: AzrnBaseEvent };
     ...
     * @ignore - do not document.
     */
    cellFocusOut: { params: GridCellParams<any>; event: AzrnBaseEvent };

    // Scroll
    /**
     * Fired during the scroll of the grid viewport.
     */
    scrollPositionChange: { params: GridScrollParams; event: React.UIEvent | AzrnBaseEvent };
    /**
