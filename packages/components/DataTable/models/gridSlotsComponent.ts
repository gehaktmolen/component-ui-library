...
export interface GridBaseSlots {
     ...
     * @default Input
     */
    BaseInput: React.JSXElementConstructor<any>;
    /**
    ...
    /**
     * The custom Toggle component used in the grid.
     * @default Toggle
     */
    BaseToggle: React.JSXElementConstructor<any>;
    /**
    ...
    /**
     * The custom FormLabel component used in the grid.
     * @default FormLabel
     */
    BaseFormLabel: React.JSXElementConstructor<any>;
    /**
...
// TODO v7: camelCase GridSlotsComponent, the `components` prop is going away.
