...
export interface GridFocusApi {
     ...
     */
    setColumnHeaderFocus: (field: string, event?: AzrnBaseEvent) => void;
    /**
     * Sets the focus to the column header filter at the given `field`.
     * @param {string} field The column field.
     * @param {string} event The event that triggers the action.
     */
    setColumnHeaderFilterFocus: (field: string, event?: AzrnBaseEvent) => void;
}
...
export interface GridFocusPrivateApi {
     ...
     */
    setColumnGroupHeaderFocus: (field: string, depth: number, event?: AzrnBaseEvent) => void;
    /**
