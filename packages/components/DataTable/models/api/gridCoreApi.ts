...
export interface GridCoreApi {
     ...
     * @param {AzrnEvent<AzrnBaseEvent>} event The event object to pass forward.
     */
...
export interface GridCorePrivateApi<GridPublicApi extends GridApiCommon, GridPrivateApi extends GridPrivateApiCommon> {
    ...
    register: <
        ...
        T extends V extends 'public' ? Partial<GridPublicApi> : Partial<Omit<GridPrivateApi, keyof GridPublicApi>>
    >(
        visibility: V,
        methods: T
    ) => void;
