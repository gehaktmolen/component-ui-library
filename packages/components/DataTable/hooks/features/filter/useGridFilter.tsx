...
function getVisibleRowsLookupState(apiRef: React.MutableRefObject<GridPrivateApiCommunity>, state: GridStateCommunity) {
...
export const useGridFilter = (
    ...
    const handleStrategyProcessorChange = React.useCallback<GridEventListener<'activeStrategyProcessorChange'>>(
        (methodName) => {
