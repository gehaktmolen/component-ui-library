...
import { GridHeaderFilteringApi, GridHeaderFilteringPrivateApi } from '../../../models/api/gridHeaderFilteringApi';
...
export const useGridHeaderFiltering = (
    ...
    const startHeaderFilterEditMode = React.useCallback<GridHeaderFilteringApi['startHeaderFilterEditMode']>(
        (field) => {
    ...
    const stopHeaderFilterEditMode = React.useCallback<GridHeaderFilteringApi['stopHeaderFilterEditMode']>(() => {
    ...
    const hideHeaderFilterMenu = React.useCallback<GridHeaderFilteringApi['hideHeaderFilterMenu']>(() => {
