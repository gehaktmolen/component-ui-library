...
export const useGridColumnHeaders = (props: UseGridColumnHeadersProps) => {
    ...
    const handleColumnResizeStop = React.useCallback<GridEventListener<'columnResizeStop'>>(() => setResizeCol(''), []);
    ...
    const getColumnHeaders = (params?: GetHeadersParams, other = {}) => {
        ...
        return (
            <div className="flex" role="row" aria-rowindex={headerGroupingMaxDepth + 1} ownerState={rootProps}>
                {columns}
            </div>
        );
    };
