...
import { GridColumnSpanningApi, GridColumnSpanningPrivateApi } from '../../../models/api/gridColumnSpanning';
...
export const useGridColumnSpanning = (apiRef: React.MutableRefObject<GridPrivateApiCommunity>) => {
    ...
    const getCellColSpanInfo = React.useCallback<GridColumnSpanningApi['unstable_getCellColSpanInfo']>(
        (rowId, columnIndex) => {
