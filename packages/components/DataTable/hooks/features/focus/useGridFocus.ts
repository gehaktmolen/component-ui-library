...
export const useGridFocus = (
    ...
    const setColumnGroupHeaderFocus = React.useCallback<GridFocusPrivateApi['setColumnGroupHeaderFocus']>(
        (field, depth, event = {}) => {
            const cell = gridFocusCellSelector(apiRef);
            if (cell) {
    ...
    const getColumnGroupHeaderFocus = React.useCallback<GridFocusPrivateApi['getColumnGroupHeaderFocus']>(
