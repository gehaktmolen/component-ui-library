...
export const preferencePanelStateInitializer: GridStateInitializer<Pick<DataGridProcessedProps, 'initialState'>> = (
    state,
    props
) => ({
    ...state,
...
export const useGridPreferencesPanel = (
    ...
    const hidePreferencesDelayed = React.useCallback<GridPreferencesPanelApi['hidePreferences']>(() => {
