import { GridColumnGroupingModel, GridColumnNode, GridColumnGroup, isLeaf } from '../../../models/gridColumnGrouping';
...
const recurrentUnwrapGroupingColumnModel = (
    ...
    if (isLeaf(columnGroupNode)) {
        if (unwrappedGroupingModelToComplete[columnGroupNode.field] !== undefined) {
            throw new Error(
                [
                    `Azrn: columnGroupingModel contains duplicated field`,
 ...
 */
export const unwrapGroupingColumnModel = (columnGroupingModel?: GridColumnGroupingModel): UnwrappedGroupingModel => {
