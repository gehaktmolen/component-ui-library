...
export const paginationStateInitializer: GridStateInitializer<
    Pick<DataGridProcessedProps, 'paginationModel' | 'rowCount' | 'initialState' | 'autoPageSize' | 'signature'>
> = (state, props) => {
...
const mergeStateWithPaginationModel =
    (rowCount: number, signature: DataGridProcessedProps['signature'], paginationModelProp?: GridPaginationModel) =>
...
export const useGridPagination = (
    ...
    const handleUpdateAutoPageSize = React.useCallback(() => {
        ...
        const maximumPageSizeWithoutScrollBar = Math.floor(
            (dimensions.viewportInnerSize.height - pinnedRowsHeight.top - pinnedRowsHeight.bottom) / rowHeight
        );
