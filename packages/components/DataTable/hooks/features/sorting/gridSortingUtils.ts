...
const sortModelDisableMultiColumnsSortingWarning = buildWarning(
    [
        'Azrn: The `sortModel` can only contain a single item when the `disableMultipleColumnsSorting` prop is set to `true`.',
...
export const getNextGridSortDirection = (sortingOrder: GridSortDirection[], current?: GridSortDirection) => {
