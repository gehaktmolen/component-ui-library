...
export function checkGridRowIdIsValid(
    ...
    if (id == null) {
        throw new Error(
            [
                'Azrn: The data grid component requires all rows to have a unique `id` property.',
...
): rowNode is GridFooterNode | GridSkeletonRowNode | GridAutoGeneratedGroupNode | GridAutoGeneratedPinnedRowNode =>
...
export const updateCacheWithNewRows = ({
    ...
    if (previousCache.updates.type === 'full') {
        throw new Error('Azrn: Unable to prepare a partial update if a full update is not applied yet');
    }
    ...
    const alreadyAppliedActionsToRemove: Record<GridRowsPartialUpdateAction, { [id: GridRowId]: true }> = {
        insert: {},
        modify: {},
        remove: {}
    };
    ...
    const actionTypeWithActionsToRemove = Object.keys(alreadyAppliedActionsToRemove) as GridRowsPartialUpdateAction[];
...
export function getMinimalContentHeight(apiRef: React.MutableRefObject<GridApiCommunity>, rowHeight: number) {
