...
import { useForkRef, useEnhancedEffect, useEventCallback } from '../../../../../utils';
...
export function binarySearch(offset: number, positions: number[], sliceStart = 0, sliceEnd = positions.length): number {
...
export const useGridVirtualScroller = (props: UseGridVirtualScrollerProps) => {
    ...
    const getRows = (
        ...
        const { focusedCellColumnIndexNotInRange, renderedColumns } = getRenderedColumnsRef.current(
            visibleColumns,
            firstColumnToRender,
            lastColumnToRender,
            minFirstColumn,
        ...
        for (let i = 0; i < renderedRows.length; i += 1) {
            ...
            const columnWithFocusedCellNotInRange =
                focusedCellColumnIndexNotInRange !== undefined && visibleColumns[focusedCellColumnIndexNotInRange];
