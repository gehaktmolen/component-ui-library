...
export const useGridStrategyProcessing = (apiRef: React.MutableRefObject<GridPrivateApiCommon>) => {
    ...
    const registerStrategyProcessor = React.useCallback<GridStrategyProcessingApi['registerStrategyProcessor']>(
        (strategyName, processorName, processor: GridStrategyProcessor<any>) => {
            ...
            const groupPreProcessors = strategiesCache.current[processorName] as UntypedStrategyProcessors;
    ...
    const applyStrategyProcessor = React.useCallback<GridStrategyProcessingApi['applyStrategyProcessor']>(
    ...
    const getActiveStrategy = React.useCallback<GridStrategyProcessingApi['getActiveStrategy']>((strategyGroup) => {
    ...
    const setStrategyAvailability = React.useCallback<GridStrategyProcessingApi['setStrategyAvailability']>(
