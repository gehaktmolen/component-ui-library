...
export type UseModalBackdropSlotProps<TOther = NonNullable<unknown>> = TOther & UseModalBackdropSlotOwnProps;

export type UseModalRootSlotProps<TOther = NonNullable<unknown>> = TOther & UseModalRootSlotOwnProps;
...
export type UseModalParameters = {
     ...
     */
    onClose?: {
        bivarianceHack(event: NonNullable<unknown>, reason: 'backdropClick' | 'escapeKeyDown'): void;
    }['bivarianceHack'];
    onKeyDown?: React.KeyboardEventHandler;
    /**
...
export interface UseModalReturnValue {
     ...
     */
    getTransitionProps: <TOther extends EventHandlers = NonNullable<unknown>>(
