...
const PopperTooltip = React.forwardRef(function PopperTooltip<RootComponentType extends React.ElementType>(
    props: PopperTooltipProps<RootComponentType>,
        ...
        if (process.env.NODE_ENV !== 'production') {
            if (resolvedAnchorElement && isHTMLElement(resolvedAnchorElement) && resolvedAnchorElement.nodeType === 1) {
                ...
                if (
                    ...
                    console.warn(
                        [
                            'Azrn: The `anchorEl` prop provided to the component is invalid.',
    ...
    return <Root {...rootProps}>{typeof children === 'function' ? children(childProps) : children}</Root>;
...
Popper.propTypes = {
     ...
     * The return value will pass as the reference object of the Popper instance.
     */
