...
export type PopperProps<RootComponentType extends React.ElementType = PopperTypeMap['defaultComponent']> =
    PolymorphicProps<PopperTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
...
export type PopperTooltipProps<RootComponentType extends React.ElementType = PopperTooltipTypeMap['defaultComponent']> =
    PolymorphicProps<PopperTooltipTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
