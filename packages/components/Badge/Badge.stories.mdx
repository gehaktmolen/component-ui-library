...
<Canvas sourceState="shown" of={BadgeDefaultStories.Rectangular} />
...
```js
import useBadge from './packages/components/useBadge';
```
...
<Canvas sourceState="shown" of={BadgeDefaultStories.Circular} />
