...
export type UseSliderRootSlotProps<TOther = NonNullable<unknown>> = Omit<TOther, keyof UseSliderRootSlotOwnProps> &
...
export type UseSliderThumbSlotProps<TOther = NonNullable<unknown>> = Omit<TOther, keyof UseSliderThumbSlotOwnProps> &
...
export type UseSliderHiddenInputProps<TOther = NonNullable<unknown>> = Omit<
    TOther,
...
export interface UseSliderReturnValue {
     ...
     */
    getHiddenInputProps: <TOther extends EventHandlers = NonNullable<unknown>>(
     ...
     */
    getThumbProps: <TOther extends EventHandlers = NonNullable<unknown>>(
        otherHandlers?: TOther
