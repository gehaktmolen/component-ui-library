...
import { GRID_DEFAULT_LOCALE_TEXT, DATA_GRID_PROPS_DEFAULT_VALUES, GridValidRowModel } from '../../DataTable';
import { computeSlots, uncapitalizeObjectKeys, useProps } from '../../DataTable/internals';
import {
    DataGridProProps,
...
export const useDataGridProProps = <R extends GridValidRowModel>(inProps: DataGridProProps<R>) => {
    const [components, componentsProps, themedProps] = useProps(inProps);
