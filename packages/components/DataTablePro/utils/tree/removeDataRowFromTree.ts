import { GRID_ROOT_GROUP_ID, GridGroupNode, GridRowId, GridRowTreeConfig, GridTreeNode } from '../../../DataTable';
import { GridTreeDepths, GridRowTreeUpdatedGroupsManager } from '../../../DataTable/internals';
import {
    getNodePathInTree,
 ...
 */
export const removeDataRowFromTree = ({ id, tree, treeDepths, updatedGroupsManager }: RemoveDataRowFromTreeParams) => {
    const node = tree[id];
