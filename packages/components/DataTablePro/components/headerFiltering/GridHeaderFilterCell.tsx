...
import { useForkRef, composeClasses, useClassNamesOverride, generateUtilityClass } from '../../../../utils';
import {
    GridFilterItem,
    GridFilterOperator,
...
const useUtilityClasses = (ownerState: OwnerState) => {
    const { colDef, showColumnVerticalBorder } = ownerState;
...
const GridHeaderFilterCell = React.forwardRef<HTMLDivElement, GridHeaderFilterCellProps>((props, ref) => {
    const {
        colIndex,
        height,
        hasFocus,
    ...
    return (
        <div
            className={twMerge(classes.root, headerClassName)}
            ref={handleRef}
            style={{
                height,
                width,
