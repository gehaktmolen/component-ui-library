...
export interface DataGridProPropsWithoutDefaultValue<R extends GridValidRowModel = any>
    extends Omit<DataGridPropsWithoutDefaultValue<R>, 'initialState' | 'componentsProps' | 'slotProps'> {
    /**
    ...
    groupingColDef?:
        ...
        | ((params: GridGroupingColDefOverrideParams) => GridGroupingColDefOverride<R> | undefined | null);
    /**
