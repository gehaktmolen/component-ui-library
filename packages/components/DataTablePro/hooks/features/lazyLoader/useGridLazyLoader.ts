...
import { useGridVisibleRows, getRenderableIndexes } from '../../../../DataTable/internals';
import { GridPrivateApiPro } from '../../../models/gridApiPro';
import { DataGridProProcessedProps, GridExperimentalProFeatures } from '../../../models/dataGridProProps';
...
export const useGridLazyLoader = (
    ...
    props: Pick<
        ...
        'onFetchRows' | 'rowsLoadingMode' | 'pagination' | 'paginationMode' | 'rowBuffer' | 'experimentalFeatures'
    >
): void => {
    ...
    const handleRenderedRowsIntervalChange = React.useCallback<GridEventListener<'renderedRowsIntervalChange'>>(
        (params) => {
