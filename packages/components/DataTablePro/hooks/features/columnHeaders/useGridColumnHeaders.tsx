...
export const useGridColumnHeaders = (props: UseGridColumnHeadersProps) => {
    ...
    const totalHeaderHeight =
        getTotalHeaderHeight(apiRef, rootProps.columnHeaderHeight) + (disableHeaderFiltering ? 0 : headerHeight);
    ...
    const getColumnFilters = (params?: GetHeadersParams, other = {}) => {
        ...
        for (let i = 0; i < renderedColumns.length; i += 1) {
            ...
            const tabIndex =
                tabIndexField === colDef.field || (isFirstColumn && !props.hasOtherElementInTabSequence) ? 0 : -1;
    ...
    return {
        ...otherProps,
        getColumnFilters,
        getRootProps: disableHeaderFiltering ? getRootProps : (other = {}) => ({ style: rootStyle, ...other })
    };
};
