...
import { GridTreePathDuplicateHandler, RowTreeBuilderGroupingCriterion } from '../../../utils/tree/models';
    ...
    const createRowTreeForTreeData = React.useCallback<GridStrategyProcessor<'rowTreeCreation'>>(
        (params) => {
            if (!props.getTreeDataPath) {
                throw new Error('Azrn: No getTreeDataPath given.');
            }
            ...
            const onDuplicatePath: GridTreePathDuplicateHandler = (firstId, secondId, path) => {
                throw new Error(
                    [
                        'Azrn: The path returned by `getTreeDataPath` should be unique.',
