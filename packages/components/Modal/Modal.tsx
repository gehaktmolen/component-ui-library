...
const Modal = React.forwardRef(function Modal<RootComponentType extends React.ElementType>(
    ...
    const { getRootProps, getBackdropProps, getTransitionProps, portalRef, isTopModal, exited, hasTransition } =
        useModal({
            ...propsWithDefaults,
    ...
    const BackdropComponent = slots.backdrop ?? 'div';
    ...
    const Container = slots.container ?? 'div';
    ...
    const ContainerInner = slots.containerInner ?? 'div';
    const containerInnerProps = useSlotProps({
        elementType: ContainerInner,
        externalSlotProps: slotProps.containerInner,
...
Modal.propTypes = {
    ...
    slotProps: PropTypes.shape({
        ...
        containerInner: PropTypes.oneOfType([PropTypes.func, PropTypes.object]),
    ...
    slots: PropTypes.shape({
        ...
        containerInner: PropTypes.elementType,
