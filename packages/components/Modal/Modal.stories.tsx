...
const Dialog = (props: { handleClose: any; children: any }) => {
    const { handleClose, children } = props;
    return (
        <div className="relative transform overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-900 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
            ...
            <div className="bg-gray-50 dark:bg-gray-950 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                ...
                <Button onClick={handleClose} color="neutral" className="mt-3 inline-flex sm:mt-0 sm:w-auto">
                    Cancel
                </Button>
            </div>
        </div>
...
export function Nested() {
    ...
    const ChildModal = () => {
        ...
        return (
            <>
                <Button onClick={handleOpen} className="inline-flex sm:ml-3">
                    Open modal
                </Button>
                <Modal
                    open={open}
                    ...
                    slotProps={{
                        container: { className: 'mt-60 ml-60' },
                        backdrop: { className: 'backdrop-blur-none' }
                    }}
                >
                    <Dialog handleClose={handleClose}>&nbsp;</Dialog>
                </Modal>
