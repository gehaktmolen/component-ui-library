                    ...
                    <div className="bg-gray-100 px-6 py-12 shadow sm:rounded-lg sm:px-12">
                        <form className="space-y-6" action="#" method="POST">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="flex w-full justify-center rounded-md bg-primary-600 px-3 py-1.5 text-sm font-semibold leading-6 text-gray-100 shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                                >
                                    Sign in
                                </button>
                            </div>
                        ...
                        <div>
                            <div className="relative mt-10">
                                ...
                                <div className="relative flex justify-center text-sm font-medium leading-6">
                                    <span className="bg-gray-100 px-6 text-gray-900">Or continue with</span>
                                </div>
                            </div>
