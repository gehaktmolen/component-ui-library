...
export type OptionGroupProps<RootComponentType extends React.ElementType = OptionGroupTypeMap['defaultComponent']> =
    PolymorphicProps<OptionGroupTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
