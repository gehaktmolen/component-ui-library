...
interface UseSelectButtonSlotEventHandlers {
    onMouseDown: CancellableEventHandler<React.MouseEvent>;
}

export type UseSelectButtonSlotProps<TOther = NonNullable<unknown>> = UseListRootSlotProps<
...
export type UseSelectListboxSlotProps<TOther = NonNullable<unknown>> = Omit<
    TOther,
...
export interface UseSelectReturnValue<Value, Multiple> {
     ...
     */
    getButtonProps: <OtherHandlers extends EventHandlers = NonNullable<unknown>>(
     ...
     */
    getListboxProps: <OtherHandlers extends EventHandlers = NonNullable<unknown>>(
        otherHandlers?: OtherHandlers
