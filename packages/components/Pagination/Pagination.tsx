            ...
            <div className="mx-auto max-w-none">
                <div className="overflow-hidden bg-gray-100 shadow sm:rounded-lg">
                    <ul role="list" className="divide-y divide-gray-200 opacity-25">
                        <li>
                            <div className="block hover:bg-gray-50 px-4 py-4"></div>
                        </li>
                        <li>
                            <div className="block hover:bg-gray-50 px-4 py-4"></div>
                        </li>
                        ...
                        <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                            ...
                            <div className="ml-auto">
                                ...
                                >
                                    ...
                                    {/* Current: "z-10 bg-primary-600 text-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600", Default: "text-gray-900 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:outline-offset-0" */}
                                    <a
                                        href=""
                                        aria-current="page"
                                        className="relative z-10 inline-flex items-center bg-primary-600 px-4 py-2 text-sm font-semibold text-gray-100 focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                                    >
                                        1
                                    </a>
                                    <a
