 ...
 */
export type ListReducerAction<ItemValue, CustomActionContext = NonNullable<unknown>> = ActionWithContext<
...
interface UseListRootSlotOwnProps {
    ...
    onBlur: CancellableEventHandler<React.FocusEvent<HTMLElement>>;
    onKeyDown: CancellableEventHandler<React.KeyboardEvent<HTMLElement>>;
    tabIndex: number;
