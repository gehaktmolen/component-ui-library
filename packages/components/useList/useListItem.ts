...
import { useForcedRerendering, useForkRef, useEnhancedEffect, extractEventHandlers } from '../../utils';
 ...
 */
export function useListItem<ItemValue>(parameters: UseListItemParameters<ItemValue>): UseListItemReturnValue {
    ...
    const { dispatch, getItemState, registerHighlightChangeHandler, registerSelectionChangeHandler } = listContext;
