...
export type TabPanelProps<RootComponentType extends React.ElementType = TabPanelTypeMap['defaultComponent']> =
    PolymorphicProps<TabPanelTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
