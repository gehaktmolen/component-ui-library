...
export interface SelectOwnProps<OptionValue extends NonNullable<unknown>, Multiple extends boolean> {
    /**
...
export interface SelectSlots<OptionValue extends NonNullable<unknown>, Multiple extends boolean> {
    /**
...
export type SelectProps<
    OptionValue extends NonNullable<unknown>,
    Multiple extends boolean,
    RootComponentType extends React.ElementType = SelectTypeMap<OptionValue, Multiple>['defaultComponent']
> = PolymorphicProps<SelectTypeMap<OptionValue, Multiple, NonNullable<unknown>, RootComponentType>, RootComponentType>;

// OverridableComponent cannot be used below as Select props are generic.
...
export type SelectOwnerState<OptionValue extends NonNullable<unknown>, Multiple extends boolean> = Simplify<
...
export type SelectRootSlotProps<OptionValue extends NonNullable<unknown>, Multiple extends boolean> = Simplify<
...
export type SelectListboxSlotProps<OptionValue extends NonNullable<unknown>, Multiple extends boolean> = Simplify<
...
export type SelectPopperSlotProps<OptionValue extends NonNullable<unknown>, Multiple extends boolean> = {
