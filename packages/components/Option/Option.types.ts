...
> = PolymorphicProps<OptionTypeMap<OptionValue, NonNullable<unknown>, RootComponentType>, RootComponentType>;

export interface OptionType {
    <OptionValue, RootComponentType extends React.ElementType = OptionTypeMap<OptionValue>['defaultComponent']>(
