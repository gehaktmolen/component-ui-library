...
export type MenuItemProps<RootComponentType extends React.ElementType = MenuItemTypeMap['defaultComponent']> =
    PolymorphicProps<MenuItemTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
