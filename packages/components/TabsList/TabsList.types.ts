...
export type TabsListProps<RootComponentType extends React.ElementType = TabsListTypeMap['defaultComponent']> =
    PolymorphicProps<TabsListTypeMap<NonNullable<unknown>, RootComponentType>, RootComponentType>;
