 ...
 * @internal
 */
export type OverridableStringUnion<T extends string | number, U = NonNullable<unknown>> = GenerateStringUnion<
...
export interface OverridableComponent<M extends OverridableTypeMap> {
    // There are types in our UI that have a similar shape to this interface
