...
import { extractEventHandlers } from '../';
import { omitEventHandlers } from './omitEventHandlers';
import { twMerge, ClassNameValue } from 'tailwind-merge';
import { Simplify, EventHandlers } from '../../types';
...
export interface MergeSlotPropsParameters<SlotProps, ExternalForwardedProps, ExternalSlotProps, AdditionalProps> {
    ...
    /**
     * Props provided to the `slotProps.*` of the UI component.
     */
    externalSlotProps?: WithCommonProps<ExternalSlotProps>;
    /**
     * Extra props placed on the UI component that should be forwarded to the slot.
 ...
 * 2. Additional props (specified internally on a UI component)
...
>(
    ...
    if (!getSlotProps) {
        ...
        const props = {
            ...
            ...externalForwardedProps,
            ...externalSlotProps
        } as MergeSlotPropsResult<SlotProps, ExternalForwardedProps, ExternalSlotProps, AdditionalProps>['props'];
