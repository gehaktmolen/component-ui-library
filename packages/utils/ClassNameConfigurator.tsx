...
const ClassNameConfiguratorContext = React.createContext<ClassNameConfiguration>(defaultContextValue);
...
export function ClassNameConfigurator(props: ClassNameConfiguratorProps) {
    ...
    return (
        <ClassNameConfiguratorContext.Provider value={contextValue}>{children}</ClassNameConfiguratorContext.Provider>
    );
}
