...
import { resolveComponentProps, mergeSlotProps, useForkRef, appendOwnerState } from '../../utils';
import type {
 ...
 */
export function useSlotProps<ElementType extends React.ElementType, SlotProps, AdditionalProps, OwnerState>(
