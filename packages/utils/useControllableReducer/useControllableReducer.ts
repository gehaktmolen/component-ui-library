...
interface UseStateChangeDetectionParameters<State extends NonNullable<unknown>> {
    /**
 ...
 */
function useStateChangeDetection<State extends NonNullable<unknown>>(
 ...
 * When a reducer action is dispatched, the internal state updated with the new values.
